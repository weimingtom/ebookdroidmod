...
public class ViewState {
    ...
    private static final ConcurrentLinkedQueue<ViewState> states = 
    		new ConcurrentLinkedQueue<ViewState>();
    ...
    public final PointF getPositionOnPage(final Page page, final int x, final int y) {
        ...
        if (view != null) {
            if (D) {
            	Log.e(TAG, "ViewState.getPositionOnPage(" + x + "," + y + "," + view.getScrollX() + ","
                    + view.getScrollY() + ")");
            }
    ...
    public class Pages {
        ...
        private StringBuilder toString(final StringBuilder buf) {
