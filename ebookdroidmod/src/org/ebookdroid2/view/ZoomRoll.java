...
public class ZoomRoll extends View implements ZoomListener {
    ...
    public ZoomRoll(final Context context, final ZoomModel zoomModel) {
        ...
        left = BitmapManager.getResource(R.drawable.ebookdroid_components_zoomroll_left, context);
        right = BitmapManager.getResource(R.drawable.ebookdroid_components_zoomroll_right, context);
        center = BitmapManager.getResource(R.drawable.ebookdroid_components_zoomroll_center, context);
        serifs = BitmapManager.getResource(R.drawable.ebookdroid_components_zoomroll_serifs, context);
