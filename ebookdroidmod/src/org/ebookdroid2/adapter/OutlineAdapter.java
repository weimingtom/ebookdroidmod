package org.ebookdroid2.adapter;
...
public class OutlineAdapter extends BaseAdapter {
    ...
    public OutlineAdapter(final Context context, final IActivityController base, final List<OutlineLink> objects,
        ...
        background = resources.getDrawable(R.drawable.ebookdroid_viewer_outline_item_background);
        selected = resources.getDrawable(R.drawable.ebookdroid_viewer_outline_item_background_selected);
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            container = LayoutInflater.from(context).inflate(R.layout.ebookdroid_outline_item, parent, false);
            firstTime = true;
        } else {
        ...
        if (states[id] == OutlineItemState.LEAF) {
            ...
            btn.setBackgroundResource(states[id] == OutlineItemState.EXPANDED ? R.drawable.ebookdroid_viewer_outline_item_expanded
                    : R.drawable.ebookdroid_viewer_outline_item_collapsed);
        }
    ...
    private final class CollapseListener implements OnClickListener {
        ...
        public void onClick(final View v) {
        	if (true) {
                ...
                final int id = (int) getItemId(position);
                final OutlineItemState newState = 
                	states[id] == OutlineItemState.EXPANDED ? 
                	OutlineItemState.COLLAPSED : 
