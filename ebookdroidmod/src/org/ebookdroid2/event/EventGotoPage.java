...
public class EventGotoPage implements IEvent {
	...
	private final static String TAG = "EventGotoPage";			
    ...
    public ViewState process() {
    	if (D) {
        	Log.e(TAG, ">>>EventGotoPage#process()");
        }
        if (model == null) {
            return null;
        }
        ...
        viewState.release();
        return EventPool.newEventScrollTo(ctrl, viewIndex, this.ctrl.getBase().getContext()).process();
    }
